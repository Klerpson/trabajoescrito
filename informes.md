...
La sexta edición de las Normas APAintrodujo cambios significativos en el formato y la citación. Comprender estos cambios es esencial para mantener la integridad de tu informe.

| Normas APA 6ta Edición | Descripción |
|:-----:|:-----:|
| Formato de la página | Margen de 1 pulgada en todos los lados, texto alineado a la izquierda y un encabezado en la parte superior de cada página |
| Tipo y tamaño de fuente | Times New Roman, 12 puntos |
| Referencias y Citas | Formateo específico para libros, artículos de revistas, sitios web, etc |
...
También, asegúrate de que *el texto esté alineado a la izquierda*.

### Paso 2: elige la fuente y el tamaño

Para el cuerpo del texto, las Normas APA recomiendan **utilizar Times New Roman en tamaño de 12 puntos**.
...
Word te permite crear títulos y subtítulos utilizando estilos predefinidos.
...
Word tiene una función de citas y referencias que puede formatear automáticamente estas para ti en el estilo APA, Icontec o IEEE.
...
Word también te permite crear una [portada profesional]({{site.baseurl}}/portada-trabajo-escrito) para tu informe.
...
Ve a la pestaña "Revisar" y utiliza las opciones de "Ortografía y gramática" para **asegurarte de que tu informe esté libre de errores.**
...
## Desglosando los tipos de informes: de lectura, laboratorio, técnicos, e investigación
...
Un informe de lectura es una herramienta invaluable en el ámbito académico. **Permite al lector comprender, analizar y sintetizar la información leída en un libro, artículo o documento académico**.

Aquí te presentamos un tutorial paso a paso para realizar un informe de lectura efectivo.
...
Dedica tiempo a leer cuidadosamente, comprendiendo y absorbiendo la información presentada. Puede que te resulte útil tomar notas mientras lees para ayudarte a recordar puntos clave.
...
Estos informes son esenciales en campos como las ciencias físicas, biológicas y sociales, y permiten a los científicos y estudiantes compartir sus hallazgos, conclusiones y el proceso empleado.
...
Los resultados son simplemente los datos que recogiste durante tu experimento. Deben ser presentados de manera clara y concisa, a menudo en forma de tablas o gráficos.
...
La conclusión resume el informe y ofrece cualquier pensamiento final sobre el experimento.
...
El siguiente paso es planificar la estructura de tu informe técnico. Un informe técnico típico **puede incluir un título, resumen, introducción, metodología, resultados, discusión, conclusiones, y referencias**.

Cada sección debe estar bien organizada y estructurada para facilitar la lectura y comprensión.
...
Un informe de investigación **es un documento académico que detalla los métodos, resultados y conclusiones de un estudio o investigación científica**. Aquí te presentamos un tutorial paso a paso sobre cómo preparar un informe de investigación impactante.
...
La revisión bibliográfica te permitirá obtener una visión general de la literatura existente sobre tu tema.

Durante esta etapa, revisarás artículos de investigación, libros, y otras fuentes relevantes para identificar los vacíos en el conocimiento existente que tu investigación podría llenar.
...
El informe debe incluir las secciones de introducción, metodología, resultados, discusión y conclusiones, todas alineadas a las normas APA, IEEE o ICONTEC, según sea apropiado.
...
¿Te gustaría hacer más fácilmente un informe de lectura, de laboratorio, técnico o de investigación? **Domina las normas APA, Icontec, y conoce cómo hacerlo en Word.** Así llegarás a la excelencia académica.
